    ...
    return (
        <div>
            <div>
                ...
                <h3>Name: {account.name}</h3><br/>
                <h3>Username: {account.username}</h3><br/>
                <h3>Address: {account.address}</h3><br/>
                <h3>Phone: {account.phoneNumber}</h3><br/>
                <h3>Balance: {account.currentBalance}</h3><br/>
            </div>
            <div>
                <NavbarBank/>
            </div>
